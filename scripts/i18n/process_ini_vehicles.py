...
parser = argparse.ArgumentParser(description="Generate vehicle i18n JSON from Star Citizen INI files.")
...
parser.add_argument(
    "--output-en",
    default=repo_root / "src" / "i18n" / "vehicles" / "en.json",
    type=Path,
    help="Path to write the generated English vehicle i18n JSON.",
)
parser.add_argument(
    "--output-zh",
    default=repo_root / "src" / "i18n" / "vehicles" / "zh.json",
    type=Path,
    help="Path to write the generated Simplified Chinese vehicle i18n JSON.",
)
